            ...
            <div class="container-fluid">
				...
				<div class="row">
					...
					<div class="input-group custom-search-form">
						<input form="search" type="text" name="patient_id" class="form-control" placeholder="Patient ID" />
								
						<span class="input-group-btn">
							<button form="search" type="submit" name="submit" formaction="find_patient.php" formmethod="post" class="btn btn-default">
