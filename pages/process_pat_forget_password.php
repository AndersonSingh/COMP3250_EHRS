	...
	*/
	...
	if(isset($_POST["submit"])){
		...
		if(!empty($errors)){
			...
			redirect("patient_forgot_password.php");
		}
		...
		if($result){
			if(mysqli_num_rows($result) == 0){
				...
				$update = "UPDATE Patient SET Password='$rand_pass_hashed', PasswordCheck='N' WHERE Email='$user';";
				...
				if($result2){
					...
					$message = 'Hi, ' . $firstName . '! Your password has been successfully reset. ' . "\n\n";
