<?php require_once("../includes/admin_session.php"); ?>
		...
		<div id="wrapper">
			...
			<div id="page-wrapper">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-6">
							<form role="form" action="create_patient.php" method="post">
								...
								<div class="form-group">
									<input type="text" name="contact_number" class="form-control" placeholder="Telephone Contact">
								</div>
						...
						<div class="col-lg-12">
							<h3 class="page-header">Emergency Contact Information</h3>
						</div>
						...
						<div class="col-lg-6">
							...
							<div class="form-group">
								<input type="text" name="emergency_phone" class="form-control" placeholder="Emergency Telephone Contact">
							</div>
						</div>
						
						<div class="col-lg-12">
							<h3 class="page-header">Address Information</h3>
						</div>
