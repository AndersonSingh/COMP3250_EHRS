<?php
	...
	if(isset($_SESSION['doctor_login'])){						// if already logged in
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form col-md-12 center-block" action="process_doctor_signin.php" method="post">
							...
							<div class="form-group">
								...
								<span><a href="doctor_forgot_password.php">Forgot your Password?</a></span>
							</div>
						</form>
					</div>
