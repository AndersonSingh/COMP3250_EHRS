	...
	<div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Create New Doctor</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>	
				...
				<div class="row">
					<div class="col-lg-6">
						<form role="form" action="create_doctor.php" method="post">
					...
					<div class="col-lg-6">
						...
						<button type="submit" name="submit" class="btn btn-primary">Add New Doctor</button>
